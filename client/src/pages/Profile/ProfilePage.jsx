...
import { WrapperContentProfile, WrapperHeader, WrapperInput, WrapperLabel, WrapperAvatar } from './style'
...
const ProfilePage = () => {
    ...
    const handleUpdate = async (value, key) => {
        ...
        const response = await apiUpdateCurrent({ [key]: value });
        setLoading(true)
        if (response.err === 0) {
            dispatch(getCurrent());
            setLoading(false)
            ...
            <Loading isLoading={loading}>
                <WrapperContentProfile>
                    ...
                    <WrapperInput>
                        ...
                        <WrapperAvatar><InputForm style={{ width: '300px' }} id="avatar" value={avatar} onChange={handleOnchangeAvatar} />
                            {avatarImg && (
                                <img src={avatarImg} style={{
                                    height: '60px',
                                    width: '60px',
                                    borderRadius: '50%',
                                    objectFit: 'cover'
                        ...
                        <ButtonComponent
                            onClick={() => handleUpdate(avatar, 'imgUS')}
                            size={40}
                            styleButton={{
                                height: '30px',
                                width: 'fit-content',
